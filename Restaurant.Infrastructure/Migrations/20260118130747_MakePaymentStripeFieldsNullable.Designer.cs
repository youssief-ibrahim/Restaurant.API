...
namespace Restaurant.Infrastructure.Migrations
{
    ...
    [Migration("20260118130747_MakePaymentStripeFieldsNullable")]
    partial class MakePaymentStripeFieldsNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Restaurant.Domain.Models.Chef", b =>
                {
                    b.HasOne("Restaurant.Infrastructure.Identity.AppilcationUser", null)
                        .WithOne("Chef")
                        .HasForeignKey("Restaurant.Domain.Models.Chef", "UserId")
            ...
            modelBuilder.Entity("Restaurant.Domain.Models.Customer", b =>
                {
                    b.HasOne("Restaurant.Infrastructure.Identity.AppilcationUser", null)
                        .WithOne("Customer")
                        .HasForeignKey("Restaurant.Domain.Models.Customer", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Restaurant.Domain.Models.Delivery", b =>
                {
                    ...
                    b.HasOne("Restaurant.Infrastructure.Identity.AppilcationUser", null)
                        .WithOne("Delivery")
                        .HasForeignKey("Restaurant.Domain.Models.Delivery", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
